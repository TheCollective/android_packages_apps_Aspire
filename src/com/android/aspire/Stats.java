...
public class Stats {
    ...
    private static final String TAG = "Aspire/Stats";

    private static final boolean LOCAL_LAUNCH_LOG = true;

    public static final String ACTION_LAUNCH = "com.android.aspire.action.LAUNCH";
    public static final String PERM_LAUNCH = "com.android.aspire.permission.RECEIVE_LAUNCH_BROADCASTS";
