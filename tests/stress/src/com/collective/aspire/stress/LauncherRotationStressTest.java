...
package com.collective.aspire.stress;


import com.collective.aspire.Launcher;
...
/**
 * Run rotation stress test using Aspire for 50 iterations.
 */
public class LauncherRotationStressTest extends ActivityInstrumentationTestCase2<Launcher> {
    ...
    private static final String LOG_TAG = "AspireRotationStressTest";
